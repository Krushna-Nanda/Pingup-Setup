  ...
  return (
    <div className='min-h-screen bg-gradient-to-b from-slate-50 to-white dark:from-gray-900 dark:to-gray-900'>
      ...
      <div className='mb-8'>
          ...
          <p className='text-slate-600 dark:text-gray-400'>Connect with amazing people and grow your network</p>
      </div>
      ...
      <div className='mb-8 shadow-md rounded-md border border-slate-200/60 dark:border-gray-700 bg-white/80 dark:bg-gray-800/80'>
        <div className='p-6'>
          <div className='relative'>
            ...
            <input type="text" placeholder='Search people by name, username, bio, or location...' className='pl-10 sm:pl-12 py-2 w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md max-sm:text-sm' onChange={(e)=>setInput(e.target.value)} value={input} onKeyUp={handleSearch}/>
          </div>
        </div>
      </div>
